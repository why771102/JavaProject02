...
<%
    ...
    System.out.println(odvb.get(0).getOrderID());
    System.out.println(odvb.get(0).getProductID());
    System.out.println(odvb.get(0).getTableCount());
%>
